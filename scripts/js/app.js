...
function setupSticky() {
    ...
    var dropdown_top = document.getElementById("mturk-top-banner");
    var dropdown = document.getElementById("mturk-top-banner-drop-down-content");
    var offset = dropdown.offsetHeight + dropdown_top.offsetHeight;
    console.log(offset);
